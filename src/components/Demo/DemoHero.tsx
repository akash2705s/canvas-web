      ...
      <div className="w-full max-w-5xl relative z-10">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-zinc-900">
            Experience an <span style={{ color: "rgba(79, 70, 229, 1)" }}>interactive</span> <span className="text-orange-500">CTV ad</span>
          </h1>
        ...
        {/* Video Container */}
        <div className="relative rounded-2xl overflow-hidden border-4 border-blue-200 shadow-2xl bg-black">
          <video
