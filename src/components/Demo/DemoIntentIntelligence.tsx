...
function useCountUp(target: number, inView: boolean, durationMs = 1200, replayToken = 0) {
...
export function DemoIntentIntelligence() {
  ...
  const totalSignals = useCountUp(2189, reveal, 1100, replayToken);
  const interactionRate = useCountUp(26.2, reveal, 1000, replayToken);
  const avgEngagement = useCountUp(14, reveal, 1000, replayToken);

  const ctaCount = useCountUp(847, reveal, 900, replayToken);
  const qrCount = useCountUp(612, reveal, 950, replayToken);
  const productCount = useCountUp(439, reveal, 1000, replayToken);
  const saveCount = useCountUp(291, reveal, 1050, replayToken);
